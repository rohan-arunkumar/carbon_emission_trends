...
def prediction(fuel_type, engine_size, cylinders, transmission, 
               fuel_consumption_city, fuel_consumption_hwy, 
               fuel_consumption_combL, fuel_consumption_combG):
    # Example preprocessing: Replace with your actual preprocessing logic
    input_data = [[fuel_type, engine_size, cylinders, transmission, 
                   fuel_consumption_city, fuel_consumption_hwy, 
                   fuel_consumption_combL, fuel_consumption_combG]]
